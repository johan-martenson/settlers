...
public class GameMap {
    ...
    public void stepTime() throws InvalidUserActionException {
        ...
        /// Preparations before running next game tick
        var duration = new Duration("GameMap.stepTime");

        // Clear lists of game impacts that are caused by game logic in the game tick
        ...
        /// Run game logic for the game tick
        ...
        /// Apply changes caused by game logic during the game tick
        ...
        // Handle the tree conservation program
    ...
    public void updateBorder(Building buildingCausedUpdate, BorderChangeCause cause) {
        ...
        var buildingsToTearDown = buildings.stream()
                ...
                .filter(building -> (!building.getPlayer().isWithinBorder(building.getPosition()) ||
                                                !building.getPlayer().isWithinBorder(building.getFlag().getPosition())))
                .toList();
