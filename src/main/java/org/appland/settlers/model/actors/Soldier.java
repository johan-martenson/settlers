...
public class Soldier extends Worker {
                    ...
                    if (countdown == 0) {
                        ...
                        if (health == 0) {
                            ...
                            if (map.isFlagAtPoint(position)) {
                                map.getFlagAtPoint(position).setNoFightAtFlag();
                            }
    ...
    protected void onIdle() {
        switch (state) {
            ...
            case WAITING_TO_DEFEND -> {
                ...
                if (buildingToDefend.getAttackers().isEmpty()) {
                ...
                } else if (home.equals(buildingToDefend)) {
                    ...
                    if (!attackerAtFlag.getPosition().equals(home.getFlag().getPosition()) || attackerAtFlag.isTraveling()) {
                        return;
                    }
                    ...
                    walkHalfWayOffroadTo(position.right(), OffroadOption.CAN_END_ON_STONE);
    ...
    protected void onArrival() throws InvalidUserActionException {
        switch (state) {
            ...
            case WALKING_TO_ATTACK -> {
                ...
                // Main attacker
                if (position.equals(buildingToAttack.getFlag().getPosition())) {
    ...
    public void attack(Building building) {
        ...
        var candidates = GameUtils.getHexagonAreaAroundPoint(buildingToAttack.getFlag().getPosition(), 6, map).stream()
                ...
                .filter(point -> map.findWayOffroad(position, point, null) != null)
        ...
        setOffroadTarget(point, home.getFlag().getPosition());
    ...
    public void defendOtherBuilding(Building building) {
        ...
        // Register in the building's defense
        building.registerRemoteDefender(this);
        home.retrieveHostedSoldier(this);
        ...
        if (!building.getWaitingAttackers().isEmpty()) {
            ...
            setOffroadTarget(candidates.getFirst(), home.getFlag().getPosition());
        }
    }
    ...
    protected void onWalkingAndAtFixedPoint() {
        switch (state) {
            case WALKING_TO_TARGET -> {
                ...
                if (!getTargetBuilding().getPlayer().equals(player)) {
            ...
            case WALKING_HOME_AFTER_FIGHT ->  {
                ...
                if (!planned.isEmpty() && home.getFlag().getPosition().equals(planned.getFirst())) {
                    home.openDoor();
                }
            }
        }
    ...
    private void prepareForFight(Soldier soldier) {
        ...
        walkHalfWayOffroadTo(position.left(), OffroadOption.CAN_END_ON_STONE);
