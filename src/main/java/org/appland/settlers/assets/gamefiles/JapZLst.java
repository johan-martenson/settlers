...
public class JapZLst {
    ...
    public static final String FILENAME = "DATA/MBOB/JAP_Z.LST";
    ...
    public static final GameFiles.House DONKEY_BREEDER = new GameFiles.House("DonkeyFarm", 202);
    ...
    public static final int MILL_SAIL_ANIMATION = 215;
    public static final int HARBOR_ANIMATION = 231;
}
