...
public class JapYLst {
    ...
    public static final int HEADQUARTER_OPEN_DOOR = 62;
    ...
    public static final int BARRACKS_OPEN_DOOR = 67;
    ...
    public static final int GUARDHOUSE_OPEN_DOOR = 72;
    ...
    public static final int WATCHTOWER_OPEN_DOOR = 77;
    ...
    public static final int FORTRESS_OPEN_DOOR = 82;
    ...
    public static final int LOOKOUT_TOWER_OPEN_DOOR = 103;
    ...
    public static final int FISHERY_OPEN_DOOR = 117;
    ...
    public static final int QUARRY_OPEN_DOOR = 122;
    ...
    public static final int FORESTER_OPEN_DOOR = 127;
    ...
    public static final int SLAUGHTER_HOUSE_OPEN_DOOR = 132;
    ...
    public static final int HUNTER_HUT_OPEN_DOOR = 137;
    ...
    public static final int BREWERY_OPEN_DOOR = 142;
    ...
    public static final int ARMORY_OPEN_DOOR = 147;
    ...
    public static final int METALWORKS_OPEN_DOOR = 152;
    ...
    public static final int IRON_SMELTER_OPEN_DOOR = 157;
    ...
    public static final int PIG_FARM_OPEN_DOOR = 162;
    ...
    public static final int STOREHOUSE_OPEN_DOOR = 167;
    public static final int MILL_NO_FAN = 168;
    public static final int MILL_NO_FAN_SHADOW = 169;
    public static final int MILL_NO_FAN_UNDER_CONSTRUCTION_SHADOW = 171;
    public static final int MILL_OPEN_DOOR = 172;
    ...
    public static final int BAKERY_OPEN_DOOR = 177;
    ...
    public static final int SAWMILL_OPEN_DOOR = 182;
    ...
    public static final int MINT_OPEN_DOOR = 187;
    ...
    public static final int SHIPYARD_OPEN_DOOR = 196;
    public static final int FARM = 197;
    public static final int FARM_SHADOW = 198;
    public static final int FARM_UNDER_CONSTRUCTION_SHADOW = 200;
    public static final int FARM_OPEN_DOOR = 201;
    public static final int DONKEY_BREEDER = 202;
    public static final int DONKEY_BREEDER_SHADOW = 203;
    public static final int DONKEY_BREEDER_UNDER_CONSTRUCTION_SHADOW = 205;
    public static final int DONKEY_BREEDER_OPEN_DOOR = 206;
    public static final int HARBOR = 207;
    public static final int HARBOR_SHADOW = 208;
    public static final int HARBOR_UNDER_CONSTRUCTION_SHADOW = 210;
