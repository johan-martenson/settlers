...
public class RomYLst {
    ...
    public static final GameFiles.House HEADQUARTER = new GameFiles.House("Headquarter", 60, false, false, true);
    public static final GameFiles.House BARRACKS = new GameFiles.House("Barracks", 63, true, true, true);
    public static final GameFiles.House GUARDHOUSE = new GameFiles.House("Guardhouse", 68, true, true, true);
    public static final GameFiles.House WATCHTOWER = new GameFiles.House("WatchTower", 73, true, true, true);
    public static final GameFiles.House FORTRESS = new GameFiles.House("Fortress", 78, true, true, true);
    public static final GameFiles.House GRANITE_MINE = new GameFiles.House("GraniteMine", 83, true, true, false);
    public static final GameFiles.House COAL_MINE = new GameFiles.House("CoalMine", 87, true, true, false);
    public static final GameFiles.House IRON_MINE = new GameFiles.House("IronMine", 91, true, true, false);
    public static final GameFiles.House GOLD_MINE = new GameFiles.House("GoldMine", 95, true, true, false);
    public static final GameFiles.House LOOKOUT_TOWER = new GameFiles.House("LookoutTower", 99, true, true, true);
    public static final GameFiles.House CATAPULT = new GameFiles.House("Catapult", 104, true, false, true);
    public static final GameFiles.House WOODCUTTER = new GameFiles.House("Woodcutter", 108, true, true, true);
    public static final GameFiles.House FISHERY = new GameFiles.House("Fishery", 113, true, true, true);
    public static final GameFiles.House QUARRY = new GameFiles.House("Quarry", 118, true, true, true);
    public static final GameFiles.House FORESTER_HUT = new GameFiles.House("ForesterHut", 123, true, true, true);
    public static final GameFiles.House SLAUGHTER_HOUSE = new GameFiles.House("SlaughterHouse", 128, true, true, true);
    public static final GameFiles.House HUNTER_HUT = new GameFiles.House("HunterHut", 133, true, true, true);
    public static final GameFiles.House BREWERY = new GameFiles.House("Brewery", 138, true, true, true);
    public static final GameFiles.House ARMORY = new GameFiles.House("Armory", 143, true, true, true);
    public static final GameFiles.House METALWORKS = new GameFiles.House("Metalworks", 148, true, true, true);
    public static final GameFiles.House IRON_SMELTER = new GameFiles.House("IronSmelter", 153, true, true, true);
    public static final GameFiles.House PIG_FARM = new GameFiles.House("PigFarm", 158, true, true, true);
    public static final GameFiles.House STOREHOUSE = new GameFiles.House("Storehouse", 163, true, true, true);
    public static final GameFiles.House MILL = new GameFiles.House("Mill", 168, true, true, true);
    public static final GameFiles.House BAKERY = new GameFiles.House("Bakery", 173, true, true, true);
    public static final GameFiles.House SAWMILL = new GameFiles.House("Sawmill", 178, true, true, true);
    public static final GameFiles.House MINT = new GameFiles.House("Mint", 183, true, true, true);
    public static final GameFiles.House WELL = new GameFiles.House("Well", 188, true, true, true);
    public static final GameFiles.House SHIPYARD = new GameFiles.House("Shipyard", 193, true, true, true);
    public static final GameFiles.House FARM = new GameFiles.House("Farm", 198, true, true, true);
    public static final GameFiles.House DONKEY_BREEDER = new GameFiles.House("DonkeyBreeder", 203, true, true, true);
    public static final GameFiles.House HARBOR = new GameFiles.House("Harbor", 208, true, true, true);
