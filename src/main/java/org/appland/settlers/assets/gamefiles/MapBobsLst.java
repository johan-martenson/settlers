...
public class MapBobsLst {
    ...
    public static final Animation CYPRESS_TREE_ANIMATION = new Animation(26, 8);
    ...
    public static final Animation CYPRESS_FALLING = new Animation(37, 4);
    public static final Animation BIRCH_TREE_ANIMATION = new Animation(41, 8);
    ...
    public static final Animation BIRCH_FALLING = new Animation(52, 4);
    public static final Animation OAK_TREE_ANIMATION = new Animation(56, 8);
    public static final int OAK_SMALLEST = 64;
    public static final int OAK_SMALL = 65;
    public static final int OAK_ALMOST_GROWN = 66;
    public static final Animation OAK_FALLING = new Animation(67, 4);
    public static final Animation PALM_1_TREE_ANIMATION = new Animation(71, 8);
    ...
    public static final Animation PALM_1_FALLING = new Animation(82, 4);
    public static final Animation PALM_2_TREE_ANIMATION = new Animation(86, 8);
    ...
    public static final Animation PALM_2_FALLING = new Animation(97, 4);
    public static final Animation PINE_APPLE_ANIMATION = new Animation(101, 8);
    public static final Animation PINE_TREE_ANIMATION = new Animation(109, 8);
    ...
    public static final Animation PINE_FALLING = new Animation(120, 4);
    public static final Animation CHERRY_TREE_ANIMATION = new Animation(124, 8);
    ...
    public static final Animation CHERRY_FALLING = new Animation(135, 4);
    public static final Animation FIR_TREE_ANIMATION = new Animation(139, 8);
    ...
    public static final Animation FIR_FALLING = new Animation(150, 4);
    public static final Animation CYPRESS_TREE_SHADOW_ANIMATION = new Animation(154, 8);
    ...
    public static final Animation CYPRESS_FALLING_SHADOW = new Animation(165, 4);
    public static final Animation BIRCH_TREE_SHADOW_ANIMATION = new Animation(169, 8);
    ...
    public static final Animation BIRCH_FALLING_SHADOW = new Animation(180, 4);
    public static final Animation OAK_TREE_SHADOW_ANIMATION = new Animation(184, 8);
    ...
    public static final Animation OAK_FALLING_SHADOW = new Animation(195, 4);
    public static final Animation PALM_1_TREE_SHADOW_ANIMATION = new Animation(199, 8);
    ...
    public static final Animation PALM_1_FALLING_SHADOW = new Animation(210, 4);
    public static final Animation PALM_2_TREE_SHADOW_ANIMATION = new Animation(214, 8);
    ...
    public static final Animation PALM_2_FALLING_SHADOW = new Animation(225, 4);
    public static final Animation PINE_APPLE_SHADOW_ANIMATION = new Animation(229, 8);
    public static final Animation PINE_TREE_SHADOW_ANIMATION = new Animation(237, 8);
    ...
    public static final Animation PINE_FALLING_SHADOW = new Animation(248, 4);
    public static final Animation CHERRY_TREE_SHADOW_ANIMATION = new Animation(252, 8);
    ...
    public static final Animation CHERRY_FALLING_SHADOW = new Animation(263, 4);
    public static final Animation FIR_TREE_SHADOW_ANIMATION = new Animation(267, 8);
    ...
    public static final Animation FIR_FALLING_SHADOW = new Animation(278, 4);
    ...
    public static final int TREE_STUB = 310;
    ...
    public static final Animation MINI_FIRE_ANIMATION = new Animation(419, 8);

    public static final Animation ICE_BEAR_WALKING_EAST_ANIMATION = new Animation(475, 6);
    public static final Animation ICE_BEAR_WALKING_SOUTH_EAST_ANIMATION = new Animation(483, 6);
    public static final Animation ICE_BEAR_WALKING_SOUTH_WEST_ANIMATION = new Animation(491, 6);
    public static final Animation ICE_BEAR_WALKING_WEST_ANIMATION = new Animation(499, 6);
    public static final Animation ICE_BEAR_WALKING_NORTH_WEST_ANIMATION = new Animation(507, 6);
    public static final Animation ICE_BEAR_WALKING_NORTH_EAST_ANIMATION = new Animation(515, 6);
    public static final Animation RABBIT_WALKING_EAST_ANIMATION = new Animation(525, 6);
    public static final Animation RABBIT_WALKING_SOUTH_EAST_ANIMATION = new Animation(531, 6);
    public static final Animation RABBIT_WALKING_SOUTH_WEST_ANIMATION = new Animation(537, 6);
    public static final Animation RABBIT_WALKING_WEST_ANIMATION = new Animation(543, 6);
    public static final Animation RABBIT_WALKING_NORTH_WEST_ANIMATION = new Animation(549, 6);
    public static final Animation RABBIT_WALKING_NORTH_EAST_ANIMATION = new Animation(555, 6);
    public static final Animation FOX_WALKING_EAST_ANIMATION = new Animation(601, 6);
    public static final Animation FOX_WALKING_SOUTH_EAST_ANIMATION = new Animation(607, 6);
    public static final Animation FOX_WALKING_SOUTH_WEST_ANIMATION = new Animation(613, 6);
    public static final Animation FOX_WALKING_WEST_ANIMATION = new Animation(619, 6);
    public static final Animation FOX_WALKING_NORTH_WEST_ANIMATION = new Animation(625, 6);
    public static final Animation FOX_WALKING_NORTH_EAST_ANIMATION = new Animation(631, 6);
    ...
    public static final Animation STAG_WALKING_EAST_ANIMATION = new Animation(644, 8);
    public static final Animation STAG_WALKING_SOUTH_EAST_ANIMATION = new Animation(652, 8);
    public static final Animation STAG_WALKING_SOUTH_WEST_ANIMATION = new Animation(660, 8);
    public static final Animation STAG_WALKING_WEST_ANIMATION = new Animation(668, 8);
    public static final Animation STAG_WALKING_NORTH_WEST_ANIMATION = new Animation(676, 8);
    public static final Animation STAG_WALKING_NORTH_EAST_ANIMATION = new Animation(684, 8);
    ...
    public static final Animation DEER_WALKING_EAST_ANIMATION = new Animation(699, 8);
    public static final Animation DEER_WALKING_SOUTH_EAST_ANIMATION = new Animation(707, 8);
    public static final Animation DEER_WALKING_SOUTH_WEST_ANIMATION = new Animation(715, 8);
    public static final Animation DEER_WALKING_WEST_ANIMATION = new Animation(723, 8);
    public static final Animation DEER_WALKING_NORTH_WEST_ANIMATION = new Animation(731, 8);
    public static final Animation DEER_WALKING_NORTH_EAST_ANIMATION = new Animation(739, 8);
    ...
    public static final Animation DEER_2_WALKING_EAST_ANIMATION = new Animation(761, 8);
    public static final Animation DEER_2_WALKING_SOUTH_EAST_ANIMATION = new Animation(769, 8);
    public static final Animation DEER_2_WALKING_SOUTH_WEST_ANIMATION = new Animation(777, 8);
    public static final Animation DEER_2_WALKING_WEST_ANIMATION = new Animation(785, 8);
    public static final Animation DEER_2_WALKING_NORTH_WEST_ANIMATION = new Animation(793, 8);
    public static final Animation DEER_2_WALKING_NORTH_EAST_ANIMATION = new Animation(801, 8);
    ...
    public static final Animation SHEEP_WALKING_EAST_ANIMATION = new Animation(818, 2);
    public static final Animation SHEEP_WALKING_SOUTH_EAST_ANIMATION = new Animation(820, 2);
    public static final Animation SHEEP_WALKING_SOUTH_WEST_ANIMATION = new Animation(822, 2);
    public static final Animation SHEEP_WALKING_WEST_ANIMATION = new Animation(824, 2);
    public static final Animation SHEEP_WALKING_NORTH_WEST_ANIMATION = new Animation(826, 2);
    public static final Animation SHEEP_WALKING_NORTH_EAST_ANIMATION = new Animation(828, 2);
    ...
    public static final Animation SMALL_FIRE_ANIMATION = new Animation(1031, 8);
    public static final Animation MEDIUM_FIRE_ANIMATION = new Animation(1039, 8);
    public static final Animation LARGE_FIRE_ANIMATION = new Animation(1047, 8);
    ...
    public static final Animation SMALL_FIRE_SHADOW_ANIMATION = new Animation(1058, 8);
    public static final Animation MEDIUM_FIRE_SHADOW_ANIMATION = new Animation(1066, 8);
    public static final Animation LARGE_FIRE_SHADOW_ANIMATION = new Animation(1074, 8);
}
