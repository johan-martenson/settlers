...
public class MapBobs0Lst {
    ...
    public static final int CAT_TAIL = 325;
    public static final int MINI_CAT_TAIL = 326;
    ...
    public static final int BROWN_MUSHROOM_SHADOW = 385;
    ...
    public static final int CAT_TAIL_SHADOW = 383;
    public static final int MINI_CAT_TAIL_SHADOW = 384;
    public static final int SMALL_STONE_WITH_GRASS_SHADOW = 386;
    public static final int SOME_SMALL_STONES_SHADOW = 387;
    public static final int SOME_SMALLER_STONES_SHADOW = 388;
    public static final int FEW_SMALL_STONES_SHADOW = 389;
    public static final int SPARSE_BUSH_SHADOW = 389;
    public static final int SOME_WATER_SHADOW = 391;
    public static final int LITTLE_GRASS_SHADOW = 392;
    public static final int SNOWMAN_SHADOW = 393;
