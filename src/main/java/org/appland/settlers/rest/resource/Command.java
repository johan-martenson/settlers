...
public enum Command {
    ...
    PLACE_FLAG_AND_ROAD,
    LISTEN_TO_STATISTICS,
    STOP_LISTENING_TO_STATISTICS,
    MARK_GAME_MESSAGES_READ,
    GET_TOOL_PRODUCTION_PRIORITIES,
    SET_TOOL_PRODUCTION_PRIORITY,
    GET_MAP,
    CHEAT,
    SET_CHEATING_ON_OFF,
    CLEAR_GAME,
    LISTEN_TO_PLAYER, STOP_LISTENING_TO_PLAYER, BLOCK_MATERIAL, ALLOW_MATERIAL, SEND_OUT_MATERIAL, STOP_SENDING_OUT_MATERIAL, GET_MAPS_WITH_TERRAIN, GET_MAP_WITH_TERRAIN, SET_PLANK_QUOTAS, GET_CHAT_HISTORY_FOR_ROOMS, PLACE_CONNECTION, GET_STATISTICS
}
