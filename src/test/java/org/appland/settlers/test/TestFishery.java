...
public class TestFishery {
    ...
    public void testOnlyOneFishermanIsNotASoldier() throws Exception {
        ...
        var fisherman0 = Utils.waitForWorkerOutsideBuilding(Fisherman.class, player0);
    ...
    public void testArrivedFishermanRestsInFisheryAndThenLeaves() throws Exception {
        ...
        var point0 = new Point(5, 5);
        map.setVegetationBelow(point0, WATER);
    ...
    public void testFishCargoIsDeliveredToMineWhichIsCloserThanHeadquarters() throws Exception {
        ...
        var road0 = map.placeAutoSelectedRoad(player0, fishery.getFlag(), coalMine.getFlag());
    ...
    public void testFishIsNotDeliveredToStorehouseUnderConstruction() throws InvalidUserActionException {
        ...
        var road0 = map.placeAutoSelectedRoad(player0, fishery.getFlag(), storehouse.getFlag());
    ...
    public void testFishIsNotDeliveredTwiceToBuildingThatOnlyNeedsOne() throws InvalidUserActionException {
        ...
        var road0 = map.placeAutoSelectedRoad(player0, fishery.getFlag(), goldMine.getFlag());
    ...
    public void testFishermanStaysInsideWhenThereIsNoWaterClose() throws Exception {
        ...
        // Place fishery
        var point1 = new Point(10, 4);
        var fishery0 = map.placeBuilding(new Fishery(player0), point1);

        // Construct the fisherman hut
        constructHouse(fishery0);

        // Put trees around the fisherman hut
        for (var point : map.getPointsWithinRadius(fishery0.getPosition(), 4)) {
    ...
    public void testPlaceFisherySoFirstMatchIsMiddleOfLake() throws Exception {
        ...
        // Place a mountain
        var point7 = new Point(5, 13);
        var point14 = new Point(8, 14);
        ...
        assertEquals(map.getVegetationUpLeft(point7), MOUNTAIN_1);
        assertEquals(map.getVegetationAbove(point7), MOUNTAIN_1);
        assertEquals(map.getVegetationUpRight(point7), MOUNTAIN_1);
        assertEquals(map.getVegetationDownRight(point7), MOUNTAIN_1);
        assertEquals(map.getVegetationBelow(point7), MOUNTAIN_1);
        assertEquals(map.getVegetationDownLeft(point7), MOUNTAIN_1);

        assertEquals(map.getVegetationUpLeft(point14), MOUNTAIN_1);
        assertEquals(map.getVegetationAbove(point14), MOUNTAIN_1);
        assertEquals(map.getVegetationUpRight(point14), MOUNTAIN_1);
        assertEquals(map.getVegetationDownRight(point14), MOUNTAIN_1);
        assertEquals(map.getVegetationBelow(point14), MOUNTAIN_1);
        assertEquals(map.getVegetationDownLeft(point14), MOUNTAIN_1);
        ...
        // Place fishery
        var point22 = new Point(10, 8);
        var fishery0 = map.placeBuilding(new Fishery(player0), point22);

        // Place road between (11, 7) and (6, 4)
        var point2 = new Point(9, 5);
        var point23 = new Point(11, 7);
        var point24 = new Point(10, 6);
        var point25 = new Point(7, 5);
        var point26 = new Point(6, 4);
        var road0 = map.placeRoad(player0, point23, point24, point2, point25, point26);
    ...
    public void testCargoProducedWithoutConnectedStorageAreDeliveredWhenStorageIsAvailable() throws Exception {
        ...
        var cargo = fishery0.getFlag().getStackedCargo().getFirst();
    ...
    public void testProductionInFisheryCanBeStopped() throws Exception {
        ...
        var point11 = new Point(12, 6);
        var point12 = new Point(11, 7);

        map.setVegetationBelow(point12, WATER);
    ...
    public void testWorkerGoesBackToOwnStorageEvenWithoutRoadsAndEnemiesStorageIsCloser() throws Exception {
        ...
        // Create game with several players
        var player0 = new Player("Player 0", PlayerColor.BLUE, Nation.ROMANS, PlayerType.HUMAN);
        ...
        var fishery0 = map.placeBuilding(new Fishery(player0), point4);
    ...
    public void testFishermanReturnsEarlyIfNextPartOfTheRoadIsRemoved() throws Exception {
        ...
        var road1 = map.placeAutoSelectedRoad(player0, flag0, fishery0.getFlag());
    ...
    public void testFisheryLosesProductivityWhenResourcesRunOut() throws Exception {
        ...
        // Wait for the fishery to get occupied
        var fisherman0 = (Fisherman) Utils.waitForNonMilitaryBuildingToGetPopulated(fishery);
    ...
    public void testFisheryReportsCorrectMaterialsNeededForConstruction() throws Exception {
        ...
        // Place fishery
        var point1 = new Point(6, 12);
        var fisher0 = map.placeBuilding(new Fishery(player0), point1);
    ...
    public void testWhenFishDeliveryAreBlockedFisheryFillsUpFlagAndThenStops() throws Exception {
        ...
        var road0 = map.placeAutoSelectedRoad(player0, fishery0.getFlag(), headquarter0.getFlag());
    ...
    public void testWorkerGoesOutAndBackInWhenSentOutWithoutBlocking() throws Exception {
        ...
        // Place fish on one tile
        var point1 = new Point(11, 11);
        map.setVegetationBelow(point1, WATER);
    ...
    public void testFishermanFishNextToWater2OnTileBelow() throws Exception {
        ...
        var point0 = new Point(5, 5);
        map.setVegetationBelow(point0, WATER_2);
        ...
        constructHouse(fishery);
        var fisherman = occupyBuilding(new Fisherman(player0, map), fishery);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            var target = fisherman.getTarget();
    ...
    public void testFishermanFishNextToWater2OnTileAbove() throws Exception {
        ...
        map.setVegetationAbove(point0, WATER_2);
    ...
    public void testFishermanFishNextToNormalWaterOnTileAbove() throws Exception {
        ...
        // Place a small lake on one tile
        var point0 = new Point(6, 4);
        map.setVegetationAbove(point0, WATER);
    ...
    public void testFishermanFishNextToBuildableWaterOnTileBelow() throws Exception {
        ...
        // Place a small lake on one tile
        var point0 = new Point(5, 5);
        map.setVegetationBelow(point0, BUILDABLE_WATER);
    ...
    public void testFishermanFishNextToBuildableWaterOnTileAbove() throws Exception {
        ...
        // Place a small lake on one tile
        var point0 = new Point(6, 4);
        map.setVegetationAbove(point0, BUILDABLE_WATER);
