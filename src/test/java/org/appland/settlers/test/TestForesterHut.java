...
public class TestForesterHut {
    ...
    public void testForesterReturnsEarlyIfNextPartOfTheRoadIsRemoved() throws Exception {
        ...
        Utils.waitForWorkersOutsideBuilding(Forester.class, 1, player0, map);
    ...
    public void testWorkerDoesNotEnterBurningBuilding() throws Exception {
        ...
        Worker worker = Utils.waitForWorkersOutsideBuilding(Forester.class, 1, player0, map).get(0);
    ...
    public void testForesterHutReportsCorrectMaterialsNeededForConstruction() throws Exception {
        ...
        assertTrue(foresterHut0.getMaterialNeeded().contains(PLANCK));
        assertEquals(foresterHut0.getTotalAmountNeeded(PLANCK), 2);
