...
public class TestMetalworks {
    ...
    public void testMetalworksCanHoldSixIronBarsAndSixPlanks() throws InvalidUserActionException {
        ...
        var road0 = map.placeAutoSelectedRoad(player0, metalworks0.getFlag(), headquarter0.getFlag());
    ...
    public void testMetalworksGetsAssignedWorker() throws Exception {
        ...
        var metalworker0 = Utils.waitForWorkerOutsideBuilding(Metalworker.class, player0);
    ...
    public void testOccupiedMetalworksWithPlanksAndIronBarsProducesTool() throws Exception {
        ...
        // Verify that the metalworker rests
        for (int i = 0; i < 100; i++) {
            assertTrue(metalworker0.isInsideBuilding());
            assertFalse(metalworker0.isHammering());
            assertFalse(metalworker0.isSawing());
        ...
        // Verify that the metalworks produces tool and performs the correct actions
        for (int i = 0; i < 30; i++) {
    ...
    public void testToolIsNotDeliveredToStorehouseUnderConstruction() throws InvalidUserActionException {
        ...
        var road0 = map.placeAutoSelectedRoad(player0, metalworks.getFlag(), storehouse.getFlag());
    ...
    public void testProductionCountdownStartsWhenPlankAndIronBarAreAvailable() throws Exception {
        ...
        // Verify that it takes 90 steps for the metalworks worker to produce a tool
        for (int i = 0; i < 90; i++) {
            assertNull(metalworker0.getCargo());
    ...
    public void testMetalworksWithoutConnectedStorageKeepsProducing() throws Exception {
        ...
        var metalworks0 = map.placeBuilding(new Metalworks(player0), point26);
    ...
    public void testProductionInMetalworksCanBeStopped() throws Exception {
        ...
        var road0 = map.placeAutoSelectedRoad(player0, metalworks0.getFlag(), headquarter.getFlag());
        ...
        var worker = new Metalworker(player0, map);
    ...
    public void testWorkerGoesBackToOwnStorageEvenWithoutRoadsAndEnemiesStorageIsCloser() throws Exception {
        ...
        var metalworks0 = map.placeBuilding(new Metalworks(player0), point4);

        // Finish construction of the metalworks
        Utils.constructHouse(metalworks0);

        // Occupy the metalworks
        var worker = Utils.occupyBuilding(new Metalworker(player0, map), metalworks0);
    ...
    public void testMetalworkerReturnsEarlyIfNextPartOfTheRoadIsRemoved() throws Exception {
        ...
        var metalworks = map.placeBuilding(new Metalworks(player0), point2.upLeft());

        // Connect headquarter and first flag
        var road0 = map.placeAutoSelectedRoad(player0, headquarter0.getFlag(), flag0);

        // Connect the first flag with the second flag
        var road1 = map.placeAutoSelectedRoad(player0, flag0, metalworks.getFlag());
    ...
    public void testMetalworkerContinuesIfCurrentPartOfTheRoadIsRemoved() throws Exception {
        ...
        // Place metalworker
        var point2 = new Point(14, 4);
        var metalworks0 = map.placeBuilding(new Metalworks(player0), point2.upLeft());

        // Connect headquarter and first flag
        var road0 = map.placeAutoSelectedRoad(player0, headquarter0.getFlag(), flag0);

        // Connect the first flag with the second flag
        var road1 = map.placeAutoSelectedRoad(player0, flag0, metalworks0.getFlag());
    ...
    public void testMetalworkerGoesOffroadBackToClosestStorageWhenMetalworksIsDestroyed() throws Exception {
        ...
        // Destroy the metalworks
        var metalworker = metalworks0.getWorker();
    ...
    public void testWhenToolDeliveryAreBlockedMetalworksFillsUpFlagAndThenStops() throws Exception {
        ...
        var metalworker0 = Utils.waitForNonMilitaryBuildingToGetPopulated(metalworks0);
    ...
    public void testWorkerGoesToOtherStorageWhereStorageIsBlockedAndMetalworksIsTornDown() throws Exception {
        ...
        var metalworks0 = map.placeBuilding(new Metalworks(player0), point2);
        ...
        var road1 = map.placeAutoSelectedRoad(player0, metalworks0.getFlag(), headquarter0.getFlag());
        ...
        var metalworker0 = metalworks0.getWorker();
    ...
    public void testWorkerGoesOutAndBackInWhenSentOutWithoutBlocking() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            var worker = Utils.waitForWorkerOutsideBuilding(Metalworker.class, player0);
